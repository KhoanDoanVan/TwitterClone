...
struct ProfileView: View {
    ...
    @StateObject private var currentProfileViewModel = CurrentProfileViewModel()
    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                ProfileListViewTweetView(viewModel: viewModel)
                Spacer()
            }
...
#Preview {
    ProfileView(user: User(id: UUID().uuidString, email: "doanvankhoan124@gmail.com", username: "Simonisdev", fullname: "Doan Van Khoan"))
}
